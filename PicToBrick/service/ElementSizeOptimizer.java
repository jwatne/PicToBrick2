...
implements Tiler {
	...
	public Mosaic tiling(int mosaicWidth,
		...
		Vector elementsSorted = sortElementsBySize(configuration.getAllElements());
		...
		if (!statistic){
			dataProcessing.setInfo(textbundle.getString("output_elementSizeOptimisation_2")+": "+elementCounter+" "+textbundle.getString("output_elementSizeOptimisation_3")+".",3);
		}else{
			//if the algorithm runs in the statistic mode (with molding optimisation)
			...
			if (dataProcessing.getTilingAlgorithm()==2){
				...
				dataProcessing.setInfo(textbundle.getString("output_elementSizeOptimisation_4")+": " + totalCosts/100 + textbundle.getString("output_decimalPoint") + totalCosts%100 + " "+textbundle.getString("output_elementSizeOptimisation_5"),3);
			}
		}
		//refresh progress bar
		//2 different bars: normal mode and statistic mode
	 ...
	 * @param            element
	 */
	private void countMolding(String color, ElementObject element){
	 ...
	 * @param            Configuration
	 */
	private void ouputMoldingUsage(Configuration configuration){
		int colorCount = configuration.getQuantityColors();
		...
		int percentUsage = (int)(100*((normalFracturedAllColors+singleFracturedAllColors) / ((normalUsageAllColors+singleUsageAllColors)/100.0)));
		//output costs, etc.
		dataProcessing.setInfo(textbundle.getString("output_elementSizeOptimisation_6")+": "
				+ (normalUsageAllColors+singleUsageAllColors) + " "+textbundle.getString("output_elementSizeOptimisation_7")+". "
				+ (normalFracturedAllColors+singleFracturedAllColors)
				+ " (" + textbundle.getString("output_elementSizeOptimisation_8") + ". " + (percentUsage/100) + textbundle.getString("output_decimalPoint") + (percentUsage%100) + " %) "+ textbundle.getString("output_elementSizeOptimisation_9")+".",3);
		dataProcessing.setInfo(textbundle.getString("output_elementSizeOptimisation_10")+" " + normalUsageAllColors + " "+textbundle.getString("output_elementSizeOptimisation_11")+" " + singleUsageAllColors
				+ " " + textbundle.getString("output_elementSizeOptimisation_12") + ": " + euro + textbundle.getString("output_decimalPoint") + centText + " " + textbundle.getString("output_elementSizeOptimisation_13"),3);
	}
	 ...
	 */
	private int computeColorNumber(String name){
	 ...
	 * @param            configuration
	 */
	private void moldingInit(Configuration configuration){
	 ...
	 */
	private Vector sortElementsBySize(Enumeration elementsUnsorted){
		int size = 0;
