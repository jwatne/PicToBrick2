...
public class ConfigurationLoader {
    ...
    public void configurationLoad() {
        ...
        ConfigurationLoadingDialog configurationLoadingDialog = new ConfigurationLoadingDialog(mainWindow,
                configurationVector);
        ...
        if (!configurationLoadingDialog.isCanceled()) {
            switch (configurationLoadingDialog.getSelection()) {
                // new configuration
                case 1:
                    ConfigurationNewDialog configurationNewDialog = new ConfigurationNewDialog(mainWindow);
