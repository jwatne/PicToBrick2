...
/**
 * class: ProgressBarsOutputFiles layer: Gui (three tier architecture)
...
public class ProgressBarsOutputFiles extends JDialog {
	...
	/**
	 * method: ProgressBarsOutputFiles description: constructor
	 *
	 * @author Adrian Schuetz
	 * @param owner
	 */
	...
	public void setStatus(final boolean graphic, final boolean configuration,
			...
			final boolean xml, final boolean miscellaneous) {
		if (!graphic) {
	...
	/**
	 * method: showValue description: changes progress bar value
	 *
	 * @author Adrian Schuetz
	 * @param value
	 * @param number
	...
	/**
	 * method: showDialog description: shows the dialog
	 *
	 * @author Adrian Schuetz
	 */
	...
	/**
	 * method: animateGraphic description: animates the graphic progress bar
