...
public class StabilityOptimisationDialog
	...
	private final JSpinner spinnerGab;
	...
	public StabilityOptimisationDialog(final Frame owner) {
		...
		final JPanel gab = new JPanel(new BorderLayout());
		...
		final TitledBorder optimierungBorder = BorderFactory
				.createTitledBorder(textbundle.getString("dialog_stabilityOptimisation_border"));
