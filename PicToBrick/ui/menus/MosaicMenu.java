...
public class MosaicMenu extends JMenu {
    ...
    public MosaicMenu(final String s, final MainWindow mainWindow) {
        ...
        menuAlgorithm11 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_naiveQuantisationRgb"),
                true);
        ...
        add(menuAlgorithm11);
        menuAlgorithm17 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_naiveQuantisationLab"));
        ...
        add(menuAlgorithm17);
        menuAlgorithm12 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_errorDiffusion"));
        ...
        add(menuAlgorithm12);
        menuAlgorithm13 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_vectorErrorDiffusion"));
        ...
        add(menuAlgorithm13);
        menuAlgorithm14 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_patternDithering"));
        ...
        add(menuAlgorithm14);
        menuAlgorithm15 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_solidRegions"));
        ...
        add(menuAlgorithm15);
        menuAlgorithm16 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_slicing"));
        ...
        menuAlgorithm25 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_basicElementsOnly"),
                true);
        ...
        menuAlgorithm21 = new JRadioButtonMenuItem(
                MainWindow.getTextBundle().getString("algorithm_elementSizeOptimisation"));
        ...
        add(menuAlgorithm21);
        menuAlgorithm22 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_moldingOptimisation"));
        ...
        add(menuAlgorithm22);
        menuAlgorithm23 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_costsOptimisation"));
        ...
        add(menuAlgorithm23);
        menuAlgorithm24 = new JRadioButtonMenuItem(MainWindow.getTextBundle().getString("algorithm_stabilityOptimisation"));
        ...
        add(menuAlgorithm24);
        addSeparator();
        menuMosaicGenerate = new JMenuItem(MainWindow.getTextBundle().getString("dialog_mainWindow_menu_31"));
