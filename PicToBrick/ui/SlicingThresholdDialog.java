...
public class SlicingThresholdDialog
	...
	public SlicingThresholdDialog(final Frame owner, final int colorCount, final Enumeration<ColorObject> colorEnum) {
		...
		final JPanel selection = new JPanel(new GridLayout(colorCount, 1, 0, 0));
		...
		for (int i = 0; i < colorCount; i++) {
			...
			final JPanel selectionThreshold = new JPanel(new GridLayout(1, 4, 10, 10));
			...
			final TitledBorder Border = BorderFactory
					.createTitledBorder(textbundle.getString("dialog_slicingThreshold_border") + " " + (i + 1) + ":");
