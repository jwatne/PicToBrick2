...
/**
 * class: ProgressBarsAlgorithms layer: Gui (three tier architecture)
...
public class ProgressBarsAlgorithms extends JDialog {
    ...
    /**
     * method: ProgressBarsAlgorithms description: constructor
     *
     * @author Adrian Schuetz
     * @param owner
     */
    ...
    /**
     * method: setStatus description: sets the status of the progress bars
     * (enabled/disabled)
     *
     * @author Adrian Schuetz
    ...
    /**
     * method: showValue description: change the progress bar value
     *
     * @author Adrian Schuetz
     * @param value
