...
public class OptionsPanel2 extends JPanel implements OptionsPanel {
    ...
    public OptionsPanel2(final LayoutManager layout, final MainWindow mainWindow) {
        ...
        buttonMosaicGenerate = new JButton(MainWindow.textbundle.getString("dialog_mainWindow_button_6"));
        buttonMosaicGenerate.setActionCommand("mosaicgenerate");
        buttonMosaicGenerate.addActionListener(mainWindow);
        guiLabelQuantisation = new JLabel(MainWindow.textbundle.getString("dialog_mainWindow_label_4") + ":");
        ...
        guiLabelTiling = new JLabel(MainWindow.textbundle.getString("dialog_mainWindow_label_5") + ":");
        ...
        buttonOutput = new JButton(MainWindow.textbundle.getString("dialog_mainWindow_button_7"));
        buttonOutput.setActionCommand("output");
        buttonOutput.addActionListener(mainWindow);
        guiRadioAlgorithm11 = new JRadioButton(MainWindow.textbundle.getString("algorithm_naiveQuantisationRgb"));
        guiRadioAlgorithm12 = new JRadioButton(MainWindow.textbundle.getString("algorithm_errorDiffusion"));
        guiRadioAlgorithm13 = new JRadioButton(MainWindow.textbundle.getString("algorithm_vectorErrorDiffusion"));
        guiRadioAlgorithm14 = new JRadioButton(MainWindow.textbundle.getString("algorithm_patternDithering"));
        guiRadioAlgorithm15 = new JRadioButton(MainWindow.textbundle.getString("algorithm_solidRegions"));
        guiRadioAlgorithm16 = new JRadioButton(MainWindow.textbundle.getString("algorithm_slicing"));
        guiRadioAlgorithm17 = new JRadioButton(MainWindow.textbundle.getString("algorithm_naiveQuantisationLab"));
        guiRadioAlgorithm21 = new JRadioButton(MainWindow.textbundle.getString("algorithm_elementSizeOptimisation"));
        guiRadioAlgorithm22 = new JRadioButton(MainWindow.textbundle.getString("algorithm_moldingOptimisation"));
        guiRadioAlgorithm23 = new JRadioButton(MainWindow.textbundle.getString("algorithm_costsOptimisation"));
        guiRadioAlgorithm24 = new JRadioButton(MainWindow.textbundle.getString("algorithm_stabilityOptimisation"));
        guiRadioAlgorithm25 = new JRadioButton(MainWindow.textbundle.getString("algorithm_basicElementsOnly"));
        ...
        guiComboBoxInterpolationsVerfahren.add(MainWindow.textbundle.getString("dialog_mainWindow_combo_1"));
        guiComboBoxInterpolationsVerfahren.add(MainWindow.textbundle.getString("dialog_mainWindow_combo_2"));
        guiComboBoxInterpolationsVerfahren.add(MainWindow.textbundle.getString("dialog_mainWindow_combo_3"));
        ...
        guiThreeDEffect = new JCheckBox(MainWindow.textbundle.getString("dialog_mainWindow_check_1"));
        guiThreeDEffect.setEnabled(true);
        guiThreeDEffect.setSelected(true);
        guiStatistic = new JCheckBox(MainWindow.textbundle.getString("dialog_mainWindow_check_2"));
