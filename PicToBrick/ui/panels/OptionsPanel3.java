...
public class OptionsPanel3 extends JPanel implements OptionsPanel {
    ...
    public OptionsPanel3(LayoutManager layout, MainWindow mainWindow) {
        ...
        buttonDocumentsGenerate = new JButton(MainWindow.getTextBundle().getString("dialog_mainWindow_button_8"));
        buttonDocumentsGenerate.addActionListener(mainWindow);
        buttonDocumentsGenerate.setActionCommand("documentgenerate");
        guiLabelOutput = new JLabel(MainWindow.getTextBundle().getString("dialog_mainWindow_label_6") + ":");
        guiOutputGraphic = new JCheckBox(MainWindow.getTextBundle().getString("dialog_mainWindow_check_3"));
        guiOutputXml = new JCheckBox(MainWindow.getTextBundle().getString("dialog_mainWindow_check_4"));
        guiOutputConfiguration = new JCheckBox(MainWindow.getTextBundle().getString("dialog_mainWindow_check_5"));
        guiOutputMaterial = new JCheckBox(MainWindow.getTextBundle().getString("dialog_mainWindow_check_6"));
        guiOutputBuildingInstruction = new JCheckBox(MainWindow.getTextBundle().getString("dialog_mainWindow_check_7"));
        ...
        buttonMosaicNew = new JButton(MainWindow.getTextBundle().getString("dialog_mainWindow_button_1"));
