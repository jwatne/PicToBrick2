...
public class DataManagement {
	...
	public Configuration configurationCopy(final Configuration configuration) {
		final Configuration kopie = new Configuration(
		...
		final Enumeration<ElementObject> elementEnum = configuration.getAllElements();
	...
	public Vector<String> getConfiguration() {
		...
		for (final Enumeration<String> configurationsEnum = configurations.elements(); configurationsEnum
				.hasMoreElements();) {
	...
	public String generateFolderOutput() {
			...
			if (list[i].isDirectory()) {
				...
				if (list[i].getName().toLowerCase().contains(imageName.toLowerCase() + "_")) {
					try {
						...
						final String sub = list[i].getName().substring(list[i].getName().length() - 3);
						// Get name of folder
						final String subrest = list[i].getName().substring(0, list[i].getName().length() - 3);
		...
		// Create subfolder
		final File subFolder = new File(projectFolder.getAbsolutePath() + "/data");
		subFolder.mkdir();
	...
	public boolean generateUTFOutput(final String content, final String fileName, final boolean subFolder) {
		...
		try {
			...
			final OutputStreamWriter output = new OutputStreamWriter(new FileOutputStream(path), "UTF-8");
	...
	public boolean generateImageOutput(final BufferedImage image, final String filename) {
		...
		final File file = new File(projectFolder + "/data/" + filename + ".jpg");
		// Iterator containing all ImageWriter (JPEG)
		final Iterator<ImageWriter> encoder = ImageIO.getImageWritersByFormatName("JPEG");
		...
		try {
			final ImageOutputStream outputStream = ImageIO.createImageOutputStream(file);
	...
	public boolean generateColorOutput(final Color color, final String colorName) {
		final BufferedImage colorImage = new BufferedImage(1, 1, BufferedImage.TYPE_INT_RGB);
	...
	public Configuration configurationLoad(final String configuration) throws IOException {
		...
		try {
			final FileInputStream file = new FileInputStream(workingDirectory + "/" + configuration);
	...
	private void initConfigurationLegoTop() {
		...
		final boolean[][] element_1x6 = { { true }, { true }, { true }, { true }, { true }, { true } };
		final boolean[][] element_8x1 = { { true, true, true, true, true, true, true, true } };
		final boolean[][] element_1x8 = { { true }, { true }, { true }, { true }, { true }, { true }, { true },
				{ true } };
		...
		final boolean[][] element_2x2_Corner_180 = { { false, true }, { true, true } };
		final boolean[][] element_2x2_Corner_270 = { { true, false }, { true, true } };
		final boolean[][] element_3x2 = { { true, true, true }, { true, true, true } };
		final boolean[][] element_2x3 = { { true, true }, { true, true }, { true, true } };
		final boolean[][] element_4x2 = { { true, true, true, true }, { true, true, true, true } };
		final boolean[][] element_2x4 = { { true, true }, { true, true }, { true, true }, { true, true } };
		final boolean[][] element_6x2 = { { true, true, true, true, true, true },
				{ true, true, true, true, true, true } };
		final boolean[][] element_2x6 = { { true, true }, { true, true }, { true, true }, { true, true },
				{ true, true }, { true, true } };
		final boolean[][] element_8x2 = { { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true } };
		final boolean[][] element_2x8 = { { true, true }, { true, true }, { true, true }, { true, true },
				{ true, true }, { true, true }, { true, true }, { true, true } };
		final boolean[][] element_4x4 = { { true, true, true, true }, { true, true, true, true },
				{ true, true, true, true }, { true, true, true, true } };
		final boolean[][] element_4x4_Corner = { { true, true, true, true }, { true, true, true, true },
				{ true, true, false, false }, { true, true, false, false } };
		final boolean[][] element_4x4_Corner_90 = { { true, true, true, true }, { true, true, true, true },
				{ false, false, true, true }, { false, false, true, true } };
		final boolean[][] element_4x4_Corner_180 = { { false, false, true, true }, { false, false, true, true },
				{ true, true, true, true }, { true, true, true, true } };
		final boolean[][] element_4x4_Corner_270 = { { true, true, false, false }, { true, true, false, false },
				{ true, true, true, true }, { true, true, true, true } };
		final boolean[][] element_6x4 = { { true, true, true, true, true, true },
				{ true, true, true, true, true, true }, { true, true, true, true, true, true },
				{ true, true, true, true, true, true } };
		final boolean[][] element_4x6 = { { true, true, true, true }, { true, true, true, true },
				{ true, true, true, true }, { true, true, true, true }, { true, true, true, true },
				{ true, true, true, true } };
		final boolean[][] element_8x4 = { { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true }, { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true } };
		final boolean[][] element_4x8 = { { true, true, true, true }, { true, true, true, true },
				{ true, true, true, true }, { true, true, true, true }, { true, true, true, true },
				{ true, true, true, true }, { true, true, true, true }, { true, true, true, true } };
		final boolean[][] element_6x6 = { { true, true, true, true, true, true },
				...
				{ true, true, true, true, true, true }, { true, true, true, true, true, true },
				{ true, true, true, true, true, true } };
		final boolean[][] element_8x6 = { { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true }, { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true }, { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true } };
		final boolean[][] element_6x8 = { { true, true, true, true, true, true },
				...
				{ true, true, true, true, true, true }, { true, true, true, true, true, true },
				{ true, true, true, true, true, true } };
		final boolean[][] element_8x8 = { { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true }, { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true }, { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true }, { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true } };
	...
	private void initConfigurationLegoSide() {
		...
		final boolean[][] element_1x3 = { { true }, { true }, { true } };
		final boolean[][] element_2x3 = { { true, true }, { true, true }, { true, true } };
		final boolean[][] element_3x3 = { { true, true, true }, { true, true, true }, { true, true, true } };
		final boolean[][] element_4x3 = { { true, true, true, true }, { true, true, true, true },
				{ true, true, true, true }, { true, true, true, true } };
		final boolean[][] element_6x3 = { { true, true, true, true, true, true },
				{ true, true, true, true, true, true }, { true, true, true, true, true, true } };
		final boolean[][] element_8x3 = { { true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true },
				{ true, true, true, true, true, true, true, true } };
	...
	public Dimension getConfigurationDimension() {
		final Dimension d = new Dimension(current.getBasisWidth(), current.getBasisHeight());
		return d;
	}
	...
	public boolean saveWorkingDirectory(final File workingDirectory) {
		try {
			final FileOutputStream file = new FileOutputStream("workingDirectory.ser");
			final ObjectOutputStream outputstream = new ObjectOutputStream(file);
	 ...
	 * description: Loads information about the current working directory (if
	 * available)
	 *
	 * @author Adrian Schuetz
	 * @return working directory
	...
	public File loadWorkingDirectory() {
		try {
			...
			final FileInputStream file = new FileInputStream("workingDirectory.ser");
